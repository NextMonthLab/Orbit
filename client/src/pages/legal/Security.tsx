  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-20">
        ...
        <p className="text-lg text-white/70 mb-4">How Orbit protects your data and supports ISO 27001-aligned workflows.</p>
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-12">
          <section>
            ...
            <p className="text-white/70 leading-relaxed mb-4">
              Security is foundational to how we build and operate Orbit. We follow industry best practices to protect your data and maintain trust.
            </p>
